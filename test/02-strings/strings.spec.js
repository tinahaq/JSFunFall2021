...
describe("2. Strings", () => {
  ...
  describe("06-replace-last-name", () => {
    it('should contain the variable or constant "newFullName" and it should be equal to a person\'s new name', () => {
      expect(replaceLastName("Gordon Ramsey", "Smith")).equal("Gordon Smith");
    });
  });

  describe("07-capitalize-last-name", () => {
    it('should contain the variable or constant "capitalizedName" and it should be equal to "fullName" it title case', () => {
